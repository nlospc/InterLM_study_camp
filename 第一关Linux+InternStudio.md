...
![[Pasted image 20240823114230.png]]
执行命令
`cat `~/.ssh/id_rsa.pub`
将内容复制到key中添加
...
![[Pasted image 20240823114632.png]]
安装完成插件以后，点击侧边栏的远程连接图标，在SSH中点击“+”按钮，添加开发机SSH连接的登录命令
![[Pasted image 20240823114848.png]]
![[Pasted image 20240823114916.png]]
【踩坑】如果出现报错Bad owner or permissions on C:\\Users\\Administrator/.ssh/config
![[Pasted image 20240823115141.png]]
...
![[Pasted image 20240823163437.png]]
...
![[Pasted image 20240823134701.png]]
创建helloworld.py文件
复制代码
执行
```
...
5. 访问接口
![[Pasted image 20240823142026.png]]
...
![[Pasted image 20240823142435.png]]



![[Pasted image 20240823142625.png]]


![[Pasted image 20240823142939.png]]

也可以通过下面命令查看有哪些虚拟环境
```
conda env list
```
![[Pasted image 20240823163955.png]]
...
![[Pasted image 20240823164802.png]]
